...
Selanjutnya, Anda akan diminta untuk log in atau register menggunakan akun IBM Cloud, fill in according to the instructions, and your page should be like this:
